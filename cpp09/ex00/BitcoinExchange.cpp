...
/*   Updated: 2025/10/22 19:31:18 by agorski          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void BitcoinExchange::inputFormatIsValid(const std::string &strValue, const std::string &date)
{
    // value validation
...
void BitcoinExchange::processingLine(std::string &line)
{
    ...
    inputFormatIsValid(strValue, date);
